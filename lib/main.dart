      ...
      debugShowCheckedModeBanner: false,
        ...
        theme: ThemeData(
          ...
          textTheme: TextTheme(
              ...
              caption: TextStyle(color: Colors.black45, fontSize: 9),
              body1: TextStyle(
                fontSize: 16,
                height: 1.5,
      ...
      bottomNavigationBar: BottomNavigationBar(
          ...
          items: <BottomNavigationBarItem>[
            BottomNavigationBarItem(
                icon: Icon(Icons.home, color: Colors.deepPurple), title: Text('Inicio')),
            BottomNavigationBarItem(
                icon: Icon(Icons.healing, color: Colors.white), title: Text(PAGE2_CATEGORY_NAME)),
            BottomNavigationBarItem(
                icon: Icon(Icons.category, color: Colors.white), title: Text('Emergencia')),
            BottomNavigationBarItem(
                icon: Icon(Icons.search, color: Colors.white), title: Text('Buscar')),
            BottomNavigationBarItem(
                icon: Icon(Icons.menu, color: Colors.white), title: Text('Config')),
          ],
